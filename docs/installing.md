...
Download and install the latest release package:
    ...
    curl -L -O https://github.com/voormedia/gcsfuse/releases/download/v0.27.0/gcsfuse-0.27.0-1.x86_64.rpm
...
Or one that uses `.deb` files:
    ...
    curl -L -O https://github.com/voormedia/gcsfuse/releases/download/v0.27.0/gcsfuse_0.27.0_amd64.deb
...
To install or update gcsfuse, run:
    ...
    go get -u github.com/voormedia/gcsfuse

This will fetch the gcsfuse sources to
`$GOPATH/src/github.com/voormedia/gcsfuse`, build them, and install a
